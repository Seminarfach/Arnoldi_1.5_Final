...
const createRiddleZone = (riddleName, dataArray) => ({
    ...
    transitionCondition: () => {
        ...
        if (riddleManager.completedRiddles.has(riddleName)) return false;
...
export const schulhofConfig = createRoomConfig({
    ...
    backgroundSrc: './img/Schulhof/Schulhof.png',
    foregroundSrc: './img/Schulhof/VordergrundSchulhof.png',
    targetLevel: 'flur0'
});
...
export const AulaConfig = createRoomConfig({
    name: "MatheRaum",
    zones: {
        main: AulaZonenData,
