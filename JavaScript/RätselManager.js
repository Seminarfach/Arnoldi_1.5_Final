            ...
            if (this.isCompleted && !this.isClicked) {
                ...
                if( this.riddleName === "ki" ) {
                    ...
                    this.fadeTransition(() => this.showGuide("ki2"))   
                        ...
                        answerText.innerHTML = this.config[this.riddleName].rewardAnswer
                        ...
                        if (this.riddleName === "ki2") {
                            ...
                            imgElement.style.maxWidth = '75%'; // Begrenzen Sie die Breite des Bildes
                            imgElement.style.height = '60%';
                            imgElement.style.position = 'absolute'
                            imgElement.style.bottom = '35%'
